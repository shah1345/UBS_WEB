...
<head>
  ...
  <title>UIU Shuttle Service</title>
</head>
...
<body>
  ...
  <section class="dashboard_1" style="margin-top: 33px;">

    <div class="container left">

      <a href="/" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-dark text-decoration-none h1">
        <svg class="bi me-2" width="40" height="32">
          <use xlink:href="#bootstrap"></use>
        </svg>
        <span class="fs-10">Dashboard</span>
      </a>
    ...
    <div class="mt-5 ms-3">
      ...
      <input class="border-2" type="text"
          name="time" placeholder="Set Your Reminder">
  ...
  <section class="dashboard_left_side">
